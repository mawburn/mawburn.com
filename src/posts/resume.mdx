...
As a devoted Full Stack Software Engineer, I excel at creating outstanding front-end experiences using TypeScript and React, prioritizing user experience (UX). I firmly advocate for collaboration between UI Designers and Engineers, backed by UX research and testing when feasible. My enthusiasm for technology encompasses mentorship, technical leadership, and promoting accessibility (a11y) best practices. I’m particularly excited about AI innovations like ChatGPT and Midjourney, which have the potential to revolutionize the industry. My extensive expertise covers Java server applications, NodeJS, GoLang, PostgreSQL, MySQL, AWS, GCP, containerization, REST, GraphQL, microservices, and serverless technologies. Adopting a growth mindset and a passion for experimentation, I relentlessly pursue advancements in scalability and software architecture to deliver cutting-edge and high-impact solutions.
</p>
